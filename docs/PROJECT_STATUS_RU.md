...
1. P2 Android: провести живую проверку новой защиты от повторных системных запросов сети при выключении и повторном включении `Wi‑Fi`; код и review уже закрыты.

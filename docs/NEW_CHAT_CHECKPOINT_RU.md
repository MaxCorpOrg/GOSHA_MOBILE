...
3. Пройти живой сценарий подключения робота и проверить:
   - открывается ли `192.168.4.1` внутри встроенного экрана приложения сразу после нажатия `Подключить робота`;
...
4. Если проблема останется, сначала собрать живые логи Android и только потом решать, нужен ли возврат к парной диагностике с прошивкой:
   ...
   - экран встроенного портала после открытия страницы

...
6. Следующий приоритет:
   ...
   - если именно во встроенном экране появится новый отказ, снова собрать живые логи и только потом решать, нужен ли возврат к прошивке;
   - сохранять живые логи `HotspotPortal`, `GoshaRobotWifi`, `RobotPortalClient`

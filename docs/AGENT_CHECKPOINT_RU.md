...
- Сборка и повторная независимая проверка завершены без P0/P1/P2. Главный следующий шаг: живой Android P1 — потеря и возврат домашнего Wi-Fi без перезапуска приложения, с одновременной проверкой событий в панели, после готовности платформы.
